...
收购数量38本及以上（这两个参考值在不同时段会有变动）后，提交卖书订单。
4.不经过扫码下单，可以直接卖书给豆芽收书吗？
强烈建议用户把想卖的书扫码下单后再寄出，如果把没有扫码的书直接寄出，平台不一定会收这本书，并且也不能保证可以取回，所以请尽量走扫码流程卖书给平台。
5.我要如何收到卖书的钱？
工作人员审核通过后，我们会在1-3天内完成书籍打款（毕业季爆仓会稍有延迟）。审核后，除去未收到的书以及审核不合格的书，其余书费将到你的豆芽账户，可以随时提现到微信零钱包。节假日期间，审核时间可能会延长，具体延时以审核通过为准。
6.卖书的物流费用谁承担？
